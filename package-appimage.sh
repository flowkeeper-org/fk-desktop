...
cp -r flowkeeper/* AppDir/usr/lib/flowkeeper/
cp ../res/flowkeeper.png AppDir/usr/share/icons/hicolor/512x512/flowkeeper/
cp ../installer/org.flowkeeper.Flowkeeper.metainfo.xml AppDir/usr/share/metainfo/org.flowkeeper.Flowkeeper.appdata.xml
echo "2. Copied application files"

# 3. Create a desktop shortcut
export FK_AUTOSTART_ARGS=""
< ../installer/flowkeeper.desktop envsubst > AppDir/org.flowkeeper.Flowkeeper.desktop
